...
class Book(models.Model):
    bookId: str = models.CharField(
        max_length=8, default='', unique=False, primary_key=True)
    ...
    description: str = models.CharField(
        max_length=2000, default='', unique=False)
...
class User(models.Model):
    ...
    wishlist: str = models.CharField(
        max_length=10000, default='', unique=False)
